...
const rawArray = ['crab', 'poison', 'contagious', 'simple', 'bring', 'sharp', 'playground', 'poison', 'communion', 'simple', 'bring'];
...
console.log('3. The sum is ' + sumNumbers(numbers));

// 3.1. A generic sum function
function sum(array) {
...
console.log('3.1. The generic sum is ' + sum(mixedArr));

// 4. Calculate the average
function averageNumbers(array) {
    return (sumNumbers(array) / array.length).toFixed(2);
}

console.log('4.1. The average value is ' + averageNumbers(numbers));
...
console.log('4.3. The generic average is ' + avg(mixedArr));
...
console.log('5. The uniquified array is ' + uniquifyArray(rawArray));
...
console.log('6. Word existance is ' + doesWordExist(words, 'brother'));
